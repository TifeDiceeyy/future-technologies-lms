...
function ButtonCta({
  ...
  return (
    <Button
      variant="ghost"
      className={cn(
        "group relative w-fit h-12 px-6 rounded-lg overflow-hidden transition-all duration-500",
        className,
      )}
      {...props}
    >
      ...
      <div className="relative flex items-center justify-center gap-2">
        <span className="text-base font-light bg-gradient-to-b from-[#D69DDE] to-[#B873F8] bg-clip-text text-transparent drop-shadow-[0_0_12px_rgba(199,135,246,0.4)] tracking-tighter">
          {label}
        </span>
      </div>
